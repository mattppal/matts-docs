  ...
  return (
    <NavigationMenu value={value} onValueChange={setValue} asChild>
      <header
        ...
        {...props}
        className={cn(
          'fixed top-(--fd-banner-height) z-40 left-0 border-b transition-colors backdrop-blur-sm backdrop-saturate-200 bg-fd-background/25 *:mx-auto *:max-w-fd-container',
          value.length > 0 && 'max-lg:shadow-lg max-lg:rounded-b-2xl',
          (!isTransparent || value.length > 0) && 'bg-fd-background/45',
          props.className,
        )}
        style={{
