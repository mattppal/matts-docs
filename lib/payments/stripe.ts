...
// import { updateOrganizationSubscription } from "@/lib/db/queries"; // Commented out since subscriptions table is disabled
...
export async function handleSubscriptionChange(
  ...
  // Subscription updates disabled since subscriptions table is commented out
  console.log(`Subscription ${status} for organization ${organization.id}`);
